# Generated by Django 4.2 on 2024-05-23 01:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('m2_construido', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('m2_terreno', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ...
                ('tipo_propiedad_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.tipo_propiedad')),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
